#import "DeviceInfoCC.h"

@implementation DeviceInfoCC
...
- (CCUICAPackageDescription *)glyphPackageDescription {
    return [CCUICAPackageDescription descriptionForPackageNamed:@"DeviceInfoCC" inBundle:[NSBundle bundleForClass:[self class]]];
}
